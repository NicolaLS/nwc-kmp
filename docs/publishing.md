...
This page documents the repository publishing workflow for maintainers.
...
```sh
curl -fsSL https://central.sonatype.com/repository/maven-snapshots/io/github/nicolals/nwc-kmp/0.3.1-SNAPSHOT/maven-metadata.xml
```
