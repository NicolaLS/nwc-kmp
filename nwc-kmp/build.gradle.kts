    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("io.github.nicolals:nostr-core:0.1.2-SNAPSHOT")
                implementation("io.github.nicolals:nostr-codec-kotlinx-serialization:0.1.2-SNAPSHOT")
                implementation("io.github.nicolals:nostr-runtime-coroutines:0.1.2-SNAPSHOT")
                implementation("io.github.nicolals:nostr-transport-ktor:0.1.2-SNAPSHOT")
                implementation("io.github.nicolals:nostr-crypto:0.1.2-SNAPSHOT")
                implementation("io.github.nicolals:nip44:0.1.2-SNAPSHOT")
                implementation("io.github.nicolals:nip04:0.1.2-SNAPSHOT")
